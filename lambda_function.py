...
AWS Lambda Function – Receipt Processing Logic

This Lambda function is triggered whenever a new receipt (PDF/JPG) is uploaded to S3.
It performs the following steps:

Reads the S3 object from the event

Uses Textract AnalyzeExpense to extract structured receipt data

Stores the extracted values in DynamoDB (Receipts table)

Sends an email notification using SES

Logs all steps in CloudWatch for debugging

 Full Lambda Code (Python)
This is the exact code used in my project.
  '''
...
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'anushrisalke03@gmail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'anushrisalke03@gmail.com')
